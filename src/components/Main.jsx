...
const Main = () => {
  return (
    <main className="main">
      <div className="main__content main__content_size ">
        <div className="main_logo">
          <img
            alt="iProBonus - бонусная система лояльности"
            src="https://iprobonus.com/wp-content/uploads/2020/03/logo.png"
            className="logo"
            data-no-lazy="1"
          />
        </div>
      ...
      <div className="main__content_size red"></div>
      <MyComponent /> 
